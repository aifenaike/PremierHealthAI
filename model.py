...
diagnosis_report_writer_template = PromptTemplate(
    input_variables=["transcript", "pharmacist_hint"],
...
diffdiag_prompt = LLMChain(llm=gpt4, prompt= diffdiag_template_prompt, verbose=True)

questions_prompt = LLMChain(llm=gpt4, prompt=questions_template_prompt, verbose=True)

diagnosis_report_writer = LLMChain(llm=gpt4,
