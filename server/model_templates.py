...
diffdiag = """##DDX model
Based on the provided conversation transcript snippets from a pharmacist-patient consultation, parse the information to generate a differential diagnosis. The results should be organized as follows:
...
Please consider the patient's stated symptoms, age, their medical history, and any other relevant information presented in the transcript.
...
Now, based on the following conversation transcript, please generate a differntial diagnosis.
